...
import (
	...
	"github.com/jalapeno/ipv6-linkstate-edge/pkg/arangodb"
	"github.com/jalapeno/ipv6-linkstate-edge/pkg/kafkamessenger"
...
var (
	...
	ipv6lsTopologyCollection string
)
...
func init() {
	...
	flag.StringVar(&ipv6lsTopologyCollection, "ls-topology-name", "ls_topology_v6", "Edge Collection name, default \"ls_topology_v6\"")
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, vertexCollection, edgeCollection,
		lsnodeExtCollection, ipv6lsTopologyCollection, notifier)
	if err != nil {
