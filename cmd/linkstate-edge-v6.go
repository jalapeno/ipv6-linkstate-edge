...
import (
	...
	"github.com/jalapeno/linkstate-edge-v6/pkg/arangodb"
	"github.com/jalapeno/linkstate-edge-v6/pkg/kafkamessenger"
...
func init() {
	...
	flag.StringVar(&lsTopologyV6Collection, "ls-topology-name", "ls_topology_v6", "Edge Collection name, default \"ls_topology_v6\"")
...
func main() {
	...
	dbSrv, err := arangodb.NewDBSrvClient(dbSrvAddr, dbUser, dbPass, dbName, lslinkCollection, lsprefixCollection,
		lsnodeExtCollection, lsTopologyV6Collection, notifier)
	if err != nil {
